...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-app-gradient flex flex-col items-center justify-center p-6 text-light_text dark:text-light_cyan-900">
      ...
      <p className="mt-4 text-gray-700 dark:text-light_cyan-900">
        Don't have an account?{" "}
        <button
          className="text-smart_blue-600 font-semibold hover:underline dark:text-turquoise_surf-600"
